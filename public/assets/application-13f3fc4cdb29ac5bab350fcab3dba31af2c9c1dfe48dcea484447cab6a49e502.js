...
(function() {
  $(document).on('ajax:success', '#createTicket', function(xhr, date, status) {
    return location.reload();
  });

  $(document).on('ajax:error', '#createTicket', function(xhr, date, status) {
    var div, form, ul;
    ...
    if ($('#createTicketErrors')[0]) {
      return $('#creeateTicketErrors').html(ul);
    } else {
      div.append(ul);
